...
export function Notifications() {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api2.cashlyzer.com/api/notifications', {
        headers
      });
  ...
  const markAsRead = async (notificationId: string) => {
    ...
    try {
      ...
      const response = await fetch(`https://api2.cashlyzer.com/api/notifications/${notificationId}/read`, {
        method: 'PATCH',
        headers
      });
  ...
  const markAllAsRead = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api2.cashlyzer.com/api/notifications/read-all', {
        method: 'PATCH',
        headers
      });
  ...
  const deleteOldNotifications = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api2.cashlyzer.com/api/notifications/old', {
        method: 'DELETE',
        headers
      });
