...
export default function DashboardPage() {
  ...
  const fetchAIInsights = async () => {
      ...
      const response = await fetch("http://api.cashlyzer.com/api/ai/insights", {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch expenses
      const expensesResponse = await fetch("http://api.cashlyzer.com/api/expenses", {
        headers: { Authorization: headers.Authorization },
        });
      ...
      // Fetch incomes
      const incomesResponse = await fetch("http://api.cashlyzer.com/api/incomes", {
        headers: { Authorization: headers.Authorization },
        });
      ...
      // Fetch budget
      const budgetResponse = await fetch("http://api.cashlyzer.com/api/budget", {
        headers: { Authorization: headers.Authorization },
      });
  ...
  const handleDeleteTransaction = async (id: string, type: "expense" | "income") => {
    try {
      ...
      const response = await fetch(`http://api.cashlyzer.com/api/${endpoint}/${id}`, {
        method: "DELETE",
        headers: {
