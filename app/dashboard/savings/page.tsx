...
export default function SavingsPage() {
  ...
  const fetchSavingsData = async () => {
      ...
      const response = await fetch("https://api2.cashlyzer.com/api/savings", {
  ...
  const handleUpdateSavings = async () => {
    try {
      ...
      const endpoint = savingsData?.id 
        ? `https://api2.cashlyzer.com/api/savings/${savingsData.id}`
        : "https://api2.cashlyzer.com/api/savings";
  ...
  const handleDeleteSavings = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://api2.cashlyzer.com/api/savings/${savingsData.id}`, {
        method: "DELETE",
        headers: { Authorization: headers.Authorization },
      });
  ...
  const handleContribute = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://api2.cashlyzer.com/api/savings/${savingsData.id}/contribute`, {
        method: 'POST',
        headers: {
          Authorization: headers.Authorization,
          'Content-Type': 'application/json',
