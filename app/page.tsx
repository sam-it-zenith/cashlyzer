  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="flex-1 px-1">
        {/* Hero Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-40 bg-gradient-to-b from-background to-muted/20">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none py-3">
                    Smart Finance Tracking with{" "}
                    <span className="text-primary">AI Insights</span>
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl" style={{textAlign: 'justify'}}>
                ...
                <div className="relative w-full max-w-[500px] aspect-square">
                  ...
                  <div className="absolute inset-[5%] rounded-2xl bg-gradient-to-tr from-background to-background/80 backdrop-blur-sm shadow-lg flex items-center justify-center">
                    <div className="grid grid-cols-2 gap-4 p-6">
                      <div className="space-y-2">
                        <div className="h-24 rounded-lg bg-primary/10 p-4 flex items-center justify-center">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="group relative overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-all hover:shadow-lg">
              ...
              <div className="group relative overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-all hover:shadow-lg">
                ...
                <div className="relative space-y-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">All-in-One Finance Toolkit</h3>
                    <p className="text-muted-foreground">
              ...
              <div className="group relative overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-all hover:shadow-lg">
                ...
                <div className="relative space-y-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">Finance Made Friendly</h3>
                    <p className="text-muted-foreground">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">Set Budgets & Goals</h3>
                    <p className="text-muted-foreground">
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">Review & Grow</h3>
                    <p className="text-muted-foreground">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="relative space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center">
                      <span className="text-lg font-semibold text-primary">KR</span>
                    </div>
                    <div>
                      <h3 className="font-semibold">Khabib Rahman</h3>
              ...
              <div className="group relative overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-all hover:shadow-lg">
                ...
                <div className="relative space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold">Rafiq Mahmud</h3>
              ...
              <div className="group relative overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-all hover:shadow-lg">
                ...
                <div className="relative space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center">
                      <span className="text-lg font-semibold text-primary">MR</span>
                    </div>
                    <div>
